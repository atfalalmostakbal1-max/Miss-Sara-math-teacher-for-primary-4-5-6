...
export class GeminiService {
  ...
  async connectLive(callbacks: {
    ...
    // Resume contexts for browser interaction requirements
    await this.outputAudioContext.resume();
    ...
    const sessionPromise = this.ai.live.connect({
      ...
      config: {
        ...
        systemInstruction: `${MISS_SARA_PROMPT}\nYou are in a real-time voice conversation with a student. Listen carefully, provide immediate feedback, and maintain your friendly persona. This is for Grade ${grade}, Lesson: ${lesson}. Always prioritize spoken interaction.`,
      },
    });
